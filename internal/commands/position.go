...
// positionFilters captures normalized position-list filters after flag parsing.
// Optional numeric filters stay as pointers so callers can distinguish an omitted
// bound from an explicit zero-dollar threshold.
