...
// ---------------------------------------------------------------------------
// Cobra tests (NewPositionCmd)
// ---------------------------------------------------------------------------

func TestNewPositionCmd_ListSingleAccount(t *testing.T) {
	// Arrange
	account := map[string]any{
		"securitiesAccount": map[string]any{
			"type":          "MARGIN",
...
func TestNewPositionCmd_ListUsesConfigDefault(t *testing.T) {
	// Arrange
	account := map[string]any{
		"securitiesAccount": map[string]any{
			"type":          "MARGIN",
...
func TestNewPositionCmd_ListAllAccounts(t *testing.T) {
	// Arrange
	accounts := []map[string]any{
		{
			"securitiesAccount": map[string]any{
...
func TestNewPositionCmd_ListAllAccounts_PreferencesFailure(t *testing.T) {
	// Arrange
	accounts := []map[string]any{
		{
			"securitiesAccount": map[string]any{
...
func TestNewPositionCmd_ListNoPositions(t *testing.T) {
	// Arrange - account exists but has no positions.
	account := map[string]any{
		"securitiesAccount": map[string]any{
			"type":          "MARGIN",
			"accountNumber": "12345",
...
func TestNewPositionCmd_MutuallyExclusiveFlags(t *testing.T) {
	// Arrange - --all-accounts and --account should not be used together.
	srv := accountMockServer(t, map[string]any{})
	defer srv.Close()
...
func TestNewPositionCmd_NoAccountConfigured(t *testing.T) {
	// Arrange
	srv := accountMockServer(t, map[string]any{})
	defer srv.Close()
...
func TestNewPositionCmd_RequestsPositionsField(t *testing.T) {
	// Arrange - verify the client sends ?fields=positions to the API.
	var capturedFields string
...
func TestNewPositionCmd_ComputedFieldsInOutput(t *testing.T) {
	// Arrange - end-to-end test verifying computed fields appear in the JSON output.
	account := map[string]any{
		"securitiesAccount": map[string]any{
			"type":          "MARGIN",
			"accountNumber": "12345",
