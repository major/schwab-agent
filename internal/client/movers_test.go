			...
			Screeners: []models.Screener{
				{
					...
					NetChange:        floatPtr(2.50),
					NetPercentChange: floatPtr(0.0169),
					Volume:           int64Ptr(12000000),
					TotalVolume:      int64Ptr(45000000),
					Trades:           int64Ptr(100000),
					MarketShare:      floatPtr(26.67),
				},
				{
					Symbol:           strPtr("NVDA"),
					Description:      strPtr("NVIDIA Corp"),
					LastPrice:        floatPtr(850.50),
					NetChange:        floatPtr(15.00),
					NetPercentChange: floatPtr(0.0179),
					Volume:           int64Ptr(8000000),
					TotalVolume:      int64Ptr(30000000),
					Trades:           int64Ptr(75000),
					MarketShare:      floatPtr(26.67),
				},
			},
		}
